    ...
    return (
        <ScrollView style={ 
            ...
            <TouchableOpacity style={styles.listItemContainer} onPress={() => navigation.navigate('Объявления')}>
                ...
                />
                <Text style={darkTheme ? styles_dark.listItem : styles.listItem}>Объявления</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.listItemContainer} onPress={() => navigation.navigate('Настройки')}>
                <Ionicons
                    ...
                    color={darkTheme ? '#fff' : '#000'}
                />
                <Text style={darkTheme ? styles_dark.listItem : styles.listItem}>Настройки</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.listItemContainer} onPress={() => navigation.navigate('Профиль')}>
                <Ionicons
                    ...
                    color={darkTheme ? '#fff' : '#000'}
                />
                <Text style={darkTheme ? styles_dark.listItem : styles.listItem}>Профиль</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.listItemContainer} onPress={() => navigation.navigate('Выход')}>
                <Ionicons
                    ...
                    color={darkTheme ? '#fff' : '#000'}
                />
                <Text style={darkTheme ? styles_dark.listItem : styles.listItem}>Выход</Text>
            </TouchableOpacity>
        </ScrollView>
    )
}
